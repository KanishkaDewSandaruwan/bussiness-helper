...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public int todayTotalSale(){
        ...
        String[] columns = {"SUM(" + SALES_TOTAL + ") AS total_price"};
        String selection = SALES_DATE + " BETWEEN datetime('now', 'start of day') AND datetime('now', 'localtime')";
        Cursor cursor = db.query(SALES_TABLE_NAME, columns, selection, null, null, null, null);
